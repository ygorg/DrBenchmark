...
def main():
    ...
    def preprocess_function(e):
        res = tokenizer(e['abstract'], truncation=True, max_length=args.max_position_embeddings, padding="do_not_pad")
    ...
    output_name = f"DrBenchmark-MORFITT-cls-{uuid.uuid4().hex}"
